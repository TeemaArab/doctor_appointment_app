...
const Appointment = () => {
  ...
  //---------------------------------------------------------------------------------------------------------------
  // Function to get available slots of doctor for next 7 days
...
//-----------------------------------------------------------------------------------------------
    // logic to remove booked slots form available slots
...
const bookAppointment = async()=>{
  ...
  return  docInfo && (
    <div>
      ...
      {/* ----------------- Booking section of doctors availability ---------------------- */}
      {/* ---------------------------------DAy and date section ---------------------- */}
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
      <p>Booking Slots</p>
      <div className='flex gap-3 items-center w-full overflow-x-auto no-scroll mt-4'>
      ...
      {/* ----------------- Time slots section ---------------------- */}
      <div className='flex items-center gap-3 w-full overflow-x-auto no-scroll mt-4 '>
